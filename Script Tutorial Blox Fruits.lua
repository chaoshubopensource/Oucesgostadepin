...
_G.imageLogo = "rbxassetid://74542926893496"
_G.Logo = "rbxassetid://12940626152"
_G.NameHub = "Made By maverickk7_" -- idk
_G.Title = "Sigma Boy Hub" --Blox Fruits 
-----------------------------------------------------------------
...
local Main = Window:Tab("Farm","14477284625")
local AutoQuest = Window:Tab("Items","11446859498")
